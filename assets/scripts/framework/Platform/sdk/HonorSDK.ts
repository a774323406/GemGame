...
export class HonorSDK extends BaseSDK {
  TAG = `HonorSDK`;
  isInited = false;
  isLogined = false;

  appCchId = "4000880"; // 聚量包id
  cchid = "215"; // 聚量渠道id
  appid = "21035"; // 聚量应用id
  appkey = "DydLV3kTqhFtev45"; // 聚量应用key
  pkgName = "com.xst.tciaa.minigame"; // 包名
  signKey = "DydLV3kTqhFtev45";
  ...
  login(cb?: Function) {
    ...
    this.sdk?.onLogin({
      success: (data) => {
        ...
        // GlobalTool.isFirstAdUser = this.sdk.isFirstAdUser();
