...
namespace GemSortingPuzzle
{
...
#endif
    {
...
#else
        // Dummy enum and type for when ads are disabled
        public enum ADS_TYPE
        {
            ADMOB,
            UNITY,
        ...
        [HideInInspector]
        public string adUnityRWUnitId = null;
#endif
        ...
        {
#if ADS_ENABLED
            Debug.Log("✓ ADS_ENABLED is ACTIVE - Ads functionality is enabled");
            ...
            InitializeUnityAds();
#else
            Debug.Log("⚠ ADS_ENABLED is INACTIVE - All ads code is disabled");
#endif
        }
